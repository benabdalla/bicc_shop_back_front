...
export class AdminService {
  adminSignup(admin: Admin): Observable<any> {
    return this.http.post<any>(this.baseUrl.concat('/signup'), admin);
  }
  ...
  getWithdrawals(): Observable<WithdrawalAdmin[]> {
    return this.http.get<WithdrawalAdmin[]>(
      this.baseUrl.concat('/withdrawals'),
      { headers: this.getHeaders() }
    );
  }
  ...
  // Get all admin users for support contact
  getAllAdmins(): Observable<Admin[]> {
    return this.http.get<Admin[]>(this.baseUrl.concat('/all'), {
      headers: this.getHeaders(),
    });
  }

  // Get admin support emails (public endpoint - no auth required)
  getSupportEmails(): Observable<string[]> {
    return this.http.get<string[]>(this.baseUrl.concat('/support/emails'));
  }
}
